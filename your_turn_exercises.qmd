## Lesson 1: Get data into right format and print table
...
From the full `gapminder` data set extract the correct data and rearrange it so that you get a data set like this:
...
Once you have rearranged your data, you can create your first table with flextable.

**Hint:** You can use this vector as a helpful tool (so that you don't have to type out the countries)
...
Redo previous with ggplot where there are dots at beginning and end of sparkline.
Maybe with label
